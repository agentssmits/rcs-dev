...
#define JTAG_PORT_DIR P1DIR
#define JTAG_PORT_IN P1IN
#define JTAG_PORT_OUT P1OUT
#define TCK     64
#define TDI     128
#define TMS     32
#define TRST    16 /* 0 Means it does not exist*/
#define TDO     8
...
extern DPUCHAR firmware_version;
...
void uart_a1_send_byte(unsigned char );
